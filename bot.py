...
@bot.tree.command(name="help", description="Lista wszystkich komend FabBota")
async def help_command(interaction: discord.Interaction):

    embed = discord.Embed(
        title="🤖 FabBot • Help Menu",
...
"""
    ...
    other = """
🛍️ /buy  
💬 (inne funkcje serwera)  
"""

    embed.add_field(name="💰 Economy", value=economy, inline=False)
    embed.add_field(name="🎰 Hazard / Gry", value=gambling, inline=False)
    embed.add_field(name="👤 Użytkownik", value=user, inline=False)
    embed.add_field(name="🛡️ Moderacja", value=moderation, inline=False)
    embed.add_field(name="📦 Inne", value=other, inline=False)

    embed.set_footer(text="FabBot • made by FabeQ 😎")
